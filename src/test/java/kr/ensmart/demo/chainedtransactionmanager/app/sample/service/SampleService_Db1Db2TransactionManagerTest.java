...
public class SampleService_Db1Db2TransactionManagerTest {
	@Autowired
	...
	void insertExceptionFromDb1WithDb1Db2TxManager() throws Exception {
		...
		sampleService.insertExceptionFromDb1WithDb1Db2TxManager();
	...
	void insertExceptionFromDb2WithDb1Db2TxManager() throws Exception {
		...
		sampleService.insertExceptionFromDb2WithDb1Db2TxManager();
