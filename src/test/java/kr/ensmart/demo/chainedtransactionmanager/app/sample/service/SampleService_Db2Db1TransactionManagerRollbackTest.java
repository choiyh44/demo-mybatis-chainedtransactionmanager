...
public class SampleService_Db2Db1TransactionManagerRollbackTest {
	@Autowired
	...
	void insertExceptionFromDb1WithDb2Db1TxManagerRollbackTest() throws Exception {
		...
		sampleService.insertExceptionFromDb1WithDb2Db1TxManagerRollbackTest();
	...
	void insertExceptionFromDb2WithDb2Db1TxManagerRollbackTest() throws Exception {
		...
		sampleService.insertExceptionFromDb2WithDb2Db1TxManagerRollbackTest();
